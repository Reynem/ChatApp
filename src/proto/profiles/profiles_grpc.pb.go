...
const (
	ProfileService_GetProfile_FullMethodName         = "/alexchatapp.ProfileService/GetProfile"
	ProfileService_CreateProfile_FullMethodName      = "/alexchatapp.ProfileService/CreateProfile"
	ProfileService_UpdateProfile_FullMethodName      = "/alexchatapp.ProfileService/UpdateProfile"
	ProfileService_UpdateOnlineStatus_FullMethodName = "/alexchatapp.ProfileService/UpdateOnlineStatus"
)
...
func (c *profileServiceClient) UpdateOnlineStatus(ctx context.Context, in *UpdateOnlineStatusRequest, opts ...grpc.CallOption) (*UpdateOnlineStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateOnlineStatusResponse)
	err := c.cc.Invoke(ctx, ProfileService_UpdateOnlineStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServiceServer) UpdateOnlineStatus(context.Context, *UpdateOnlineStatusRequest) (*UpdateOnlineStatusResponse, error) {
...
func _ProfileService_UpdateOnlineStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateOnlineStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).UpdateOnlineStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_UpdateOnlineStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).UpdateOnlineStatus(ctx, req.(*UpdateOnlineStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "alexchatapp.ProfileService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProfileService_UpdateOnlineStatus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "src/proto/profiles.proto",
}
